...
由于样本不均匀 比例大概是 FAKE:REAL = 8:2

针对fake 视频数据又做了个 0.2的重采样

最终数据比例大概是 FAKE:REAL = 6.5:3.5
...
def Data_Loader(data_dir, video_dir, savedir):
    ...
    video_dir = video_dir
    threshold = 0.2  # 对fake video进一步采样，以保证均衡
...
if __name__ == "__main__":
    ...
    save_dir = "/home/aistudio/work/validate_frame"
